...
Detailed description of process to deploy selenium python script as AWS lambda function to allow for serverless testing. Selenium runs off of a headless chrome binary and is driven by a chrome driver, each deployed as layers to the lambda function.
